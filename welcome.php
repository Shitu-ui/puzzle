...
<head>
    ...
    <link rel="stylesheet" href="puzzle\Style\style1.css">
...
<body>
    ...
    <script>
            ...
            setTimeout(() => {
                ...
                if(corrects.length === word.length){
                    ...
                    for(let i = 0; i < word.length; i++){
                        ...
                        if(cnt==0)
                        {
                            alert(`You reached at max attempts!!!!!. `);
                            window.location.href = 'describe.php';
                        }
                    }
        ...
        function storeMaxGuesses(maxGuesses) {
            ...
            const data = "maxGuesses=" + encodeURIComponent(maxGuesses);
            xhr.send(data);
        }
